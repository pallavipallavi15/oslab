...
<html>
  <head>
    ...
    />
    <link rel="canonical" href="https://www.programiz.com/c-programming/online-compiler/" />    <meta
      name="description"
      content="The user friendly C online compiler that allows you to Write C code and run it online. The C text editor also supports taking input from the user and standard libraries. It uses the GCC C compiler to compile code."
    />
        ...
        <div class="nav-menu">
          ...
          <div class="nav-menu-list">
            ...
            <a
              ...
              class="change-lang-row c active"
      ...
      <div class="wrapper">
        ...
        <div class="sidebar-wrapper">
          ...
          <a
            target="_blank"
            href="https://www.programiz.com/c-programming/online-compiler/"
            class="change-lang-btn c active"
        ...
        <div class="editor-wrapper">
          ...
          <div id="editor">// Online C compiler to run C program online
#include &lt;stdio.h&gt;
    ...
    return 0;
        ...
        <div class="terminal-wrapper">
          ...
          <div class="sale-popup" id="sale-popup">
            ...
            <a
              id="claim-discount"
              href="https://programiz.pro?utm_source=popup-compiler&utm_medium=popup"
